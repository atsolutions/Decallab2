...
function email_invoice($invoice_id, $invoice_template, $from, $to, $subject, $body, $email_server, $email_port, $email_user, $email_pass,  $cc = NULL, $bcc = NULL,$attachments = NULL)
{
    $CI = &get_instance();
    ...
    return phpmail_send($from, $to, $subject, $message, $email_server, $email_port, $email_user, $email_pass, $invoice, $cc, $bcc,$attachments);
}

function email_quote($quote_id, $quote_template, $from, $to, $subject, $body,$email_server, $email_port, $email_user, $email_pass, $cc = NULL, $bcc = NULL,$attachments = NULL)
{
    $CI = &get_instance();
    ...
    return phpmail_send($from, $to, $subject, $message, $email_server, $email_port, $email_user, $email_pass, $quote, $cc, $bcc,$attachments);
}
