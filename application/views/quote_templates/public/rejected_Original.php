...
<center><a href="#" class="btn btn-danger" style="text-decoration: none"><?php echo lang('quote_rejected'); ?></a></center>
			<div class="pull-right">
						...
						<form action="" method="post" name= "comments" enctype="multipart/form-data">
							...
							name=my_text 
							placeholder=" You have rejected this design. If you have more comments please enter your corrections/comments here ... Attach more files if neccesary.
 Jus esat noraidījuši šo dizainu. Ja nepieciešams varat pievienot vēl komentārus (Send more Corrections). Pievienojiet papildus failus (Attach files) ja nepieciešaams"></textarea>
							...
							<div class="pull-right">
								...
								<button onclick="rejected()"type="submit" name="correct" class="btn btn-danger">Send more corrections</button>
