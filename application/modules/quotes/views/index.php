    ...
    <div class="collapse clearfix" id="ip-submenu-collapse">
        ...
        <div class="submenu-row">
            <ul class="nav nav-pills index-options">
				...
				<li <?php if ($status == 'designer') { ?>class="active"<?php } ?>><a
                        href="<?php echo site_url('quotes/status/designer'); ?>"><?php echo 'Designer'; ?></a>
                </li>
            </ul>
        </div>
...
<div id="content" class="table-content">
    ...
    <div id="filter_results">
        <?php $this->layout->load_view('quotes/partial_quote_table', array('quotes' => $quotes, 'custom_fields'=>$custom)); ?>
    </div>
